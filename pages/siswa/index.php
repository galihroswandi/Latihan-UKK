...
if (!isset($_POST['btn_search'])) {
    ...
    $sql = "SELECT * FROM siswa WHERE nama LIKE '%$keyword%' OR no_telp  LIKE '%$keyword%' OR alamat LIKE '%$keyword%'";
                ...
                <tbody>
                    <?php foreach ($data as $siswa) : ?>
                        <tr>
                            ...
                            <td><?= $siswa['no_telp'] ?></td>
                            <td><?= $siswa['tahun'] ?></td>
                            <td><a href="?p=siswa/ubah&nisn=<?= $siswa['nisn'] ?>">Ubah</a> | <a onclick="return confirm('Apakah anda yakin ingin menghapus ?')" href="?p=siswa/hapus&nisn=<?= $siswa['nisn'] ?>">Hapus</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
            <div class="link">
                <a href="./pages/siswa/print.php"><svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    Download PDF</a>
                <a href="?p=siswa/tambah"><svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11 21C16.5228 21 21 16.5228 21 11C21 5.47715 16.5228 1 11 1C5.47715 1 1 5.47715 1 11C1 16.5228 5.47715 21 11 21Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M11 7V15" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M7 11H15" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
